    ...
    <>
      ...
      >
        ...
        <select defaultValue={"Other"} {...register("category")}>
          <option style={{color: "red", fontWeight:"bold", textAlign:"center"}} value="Jewelery">Jewelery</option>
          <option style={{color: "red", fontWeight:"bold", textAlign:"center"}} value="Men's clothing">Men's clothing</option>
          <option style={{color: "red", fontWeight:"bold", textAlign:"center"}} value="Women's clothing">Women's clothing</option>
          <option style={{color: "red", fontWeight:"bold", textAlign:"center"}} value="Electronics">Electronics</option>
          <option style={{color: "red", fontWeight:"bold", textAlign:"center"}} value="Other">Other</option>
        </select>
        <AddImage setImage={setImage} text={'Set product picture'} />
        <textarea placeholder="Product description"{...register("description")} maxLength={200} />
        {errors.description && <p>{errors.description.message}</p>}
        <Button className={"addProductButton"} type="submit">Wyślij</Button>
      </form>
      <Toaster />
    </>
  );
